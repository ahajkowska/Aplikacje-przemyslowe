...
class EmployeeServiceTest {
    ...
    class AddEmployeeTests {
        ...
        void shouldThrowException_whenEmailAlreadyExists() {
            ...
            assertThrows(IllegalArgumentException.class, () -> employeeService.addEmployee(duplicateEmail));
        }
        ...
        void shouldAddMultipleEmployees_whenAllHaveUniqueEmails() {
            ...
            Employee employee3 = new Employee("Piotr", "Wiśniewski", "piotr@firm.pl", "Corp", Position.DEVELOPER, 8500);
    ...
    // WALIDACJA KONSTRUKTORA EMPLOYEE
    ...
    class EmployeeConstructorValidationTests {
        ...
        void shouldThrowException_whenLastNameIsNull() {
            assertThrows(
                    IllegalArgumentException.class,
                    () -> new Employee("Jan", null, "jan@firm.pl", "Corp", Position.DEVELOPER, 9000)
            );
        }
        ...
        void shouldThrowException_whenEmailIsNull() {
            assertThrows(
                    IllegalArgumentException.class,
                    () -> new Employee("Jan", "Kowalski", null, "Corp", Position.DEVELOPER, 9000)
            );
        }

        @Test
        @DisplayName("should throw exception when company is null")
        void shouldThrowException_whenCompanyIsNull() {
            assertThrows(
                    IllegalArgumentException.class,
                    () -> new Employee("Jan", "Kowalski", "jan@firm.pl", null, Position.DEVELOPER, 9000)
            );
        }
        ...
        void shouldThrowException_whenPositionIsNull() {
            assertThrows(
                    IllegalArgumentException.class,
                    () -> new Employee("Jan", "Kowalski", "jan@firm.pl", "Corp", null, 9000)
            );
        }
    ...
    class FindEmployeesInCompanyTests {
        ...
        void shouldThrowException_whenCompanyNameIsNull() {
            assertThrows(IllegalArgumentException.class, () -> employeeService.findEmployeesInCompany(null));
        }

        @Test
        @DisplayName("should throw exception when company name is blank")
        void shouldThrowException_whenCompanyNameIsBlank() {
            assertThrows(IllegalArgumentException.class, () -> employeeService.findEmployeesInCompany("   "));
        }

        @Test
        @DisplayName("should throw exception when company name is empty string")
        void shouldThrowException_whenCompanyNameIsEmpty() {
            assertThrows(IllegalArgumentException.class, () -> employeeService.findEmployeesInCompany(""));
        }
    }
